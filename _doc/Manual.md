...
```yml
# Site settings
title: Hzy Blog             # title of your website
SEOTitle: Hzy Blog          # check out docs for more detail
description: "Unusual Blog"    # ...

# SNS settings      
github_username: haiziyao     # modify this account to yours
